...
for i = 1 : length(urdf_sets)
    ...
    %% acquire the number of states and inputs of the system
    torso_dof = 3;
    ...
    %%
    link_len = tail_len / link_num;
    
    %%
    if link_num == 3
        joint1_pos = eul2rotm_func(q(1:3))*([0; torso_len/2; 0]);
        joint2_pos = joint1_pos + eul2rotm_func(q(1:3))*eul2rotm_func([q(4); sym(0); q(5)])*([0; link_len; 0]);
        joint3_pos = joint2_pos + eul2rotm_func(q(1:3))*eul2rotm_func([q(4); sym(0); q(5)])*eul2rotm_func([q(6); sym(0); q(7)])*([0; link_len; 0]);

        ee_sph_ctr = joint3_pos + eul2rotm_func(q(1:3))*eul2rotm_func([q(4); sym(0); q(5)])*eul2rotm_func([q(6); sym(0); q(7)])*...
                     eul2rotm_func([q(8); sym(0); q(9)])*([0; link_len; 0]);
    ...
    elseif link_num == 4
        ...
        ee_sph_ctr = joint4_pos + eul2rotm_func(q(1:3))*eul2rotm_func([q(4); sym(0); q(5)])*eul2rotm_func([q(6); sym(0); q(7)])*...
                     eul2rotm_func([q(8); sym(0); q(9)])*eul2rotm_func([q(10); sym(0); q(11)])*([0; link_len; 0]);
    ...
    elseif link_num == 5
        ...
        ee_sph_ctr = joint5_pos + eul2rotm_func(q(1:3))*eul2rotm_func([q(4); sym(0); q(5)])*eul2rotm_func([q(6); sym(0); q(7)])*...
                     eul2rotm_func([q(8); sym(0); q(9)])*eul2rotm_func([q(10); sym(0); q(11)])*eul2rotm_func([q(12); sym(0); q(13)])*([0; link_len; 0]);
    ...
    elseif link_num == 6
        ...
        ee_sph_ctr = joint6_pos + eul2rotm_func(q(1:3))*eul2rotm_func([q(4); sym(0); q(5)])*eul2rotm_func([q(6); sym(0); q(7)])*...
                     ...
                     eul2rotm_func([q(14); sym(0); q(15)])*([0; link_len; 0]);
    ...
    selfcoll_con_grad = jacobian(selfcoll_con.', q);
    
    %%
    if link_num == 3
        matlabFunction(selfcoll_con.', 'Vars', {q}, 'File', ['selfcollision_con', filesep, 'three_link_2JDOF_selfcollision_con_3DOF_float', ]);
        matlabFunction(selfcoll_con_grad, 'Vars', {q}, 'File', ['selfcollision_con', filesep, 'three_link_2JDOF_selfcollision_con_grad_3DOF_float']);
    
    elseif link_num == 4
        matlabFunction(selfcoll_con.', 'Vars', {q}, 'File', ['selfcollision_con', filesep, 'four_link_2JDOF_selfcollision_con_3DOF_float', ]);
        matlabFunction(selfcoll_con_grad, 'Vars', {q}, 'File', ['selfcollision_con', filesep, 'four_link_2JDOF_selfcollision_con_grad_3DOF_float']);
    
    elseif link_num == 5
        matlabFunction(selfcoll_con.', 'Vars', {q}, 'File', ['selfcollision_con', filesep, 'five_link_2JDOF_selfcollision_con_3DOF_float', ]);
        matlabFunction(selfcoll_con_grad, 'Vars', {q}, 'File', ['selfcollision_con', filesep, 'five_link_2JDOF_selfcollision_con_grad_3DOF_float']);
    
    elseif link_num == 6
        matlabFunction(selfcoll_con.', 'Vars', {q}, 'File', ['selfcollision_con', filesep, 'six_link_2JDOF_selfcollision_con_3DOF_float', ]);
        matlabFunction(selfcoll_con_grad, 'Vars', {q}, 'File', ['selfcollision_con', filesep, 'six_link_2JDOF_selfcollision_con_grad_3DOF_float']);
